      ...
      <section id="events" className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-end justify-between mb-10">
            <div>
              <span className="text-xs font-black uppercase tracking-[4px] text-red-600 border-l-4 border-red-600 pl-3 block mb-3">
                What&apos;s On
              </span>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-20 items-center">
          ...
          <div>
            ...
            <p className="text-gray-500 leading-relaxed mb-4">
              Eventify is a modern event discovery platform connecting people
              with local workshops, tech conferences, networking events, and
              cultural experiences across Pakistan.
            </p>
            <p className="text-gray-500 leading-relaxed mb-10">
              Whether you&apos;re a student, a professional, or an organiser —
              Eventify is your platform.
            </p>
            ...
            <div className="flex gap-10">
              {[
                ...
                <div key={stat.label}>
                  ...
                  <p className="text-xs text-gray-400 uppercase tracking-[3px] mt-1">
                    {stat.label}
                  </p>
                </div>
              ))}
